...
/**
 * Final Exam Scheduler using Genetic Algorithm (Sequential version)
 * Usage: java FESGeneticSeq <sections-file> <students-file> <relationship-file> [schedule-output-file]
...
public class FESGeneticSeq {
	...
	public static void main(final String[] args) throws Exception {
		...
		// determine number of generation to run
		final int gen = Integer.parseInt(System.getProperty("fes.ga.gen", "500"));
	...
	public static void usage() {
		System.err.println("Usage: java FESGeneticSeq <sections-file> <students-file> <relationship-file> [schedule-output-file]");
